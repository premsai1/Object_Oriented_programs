 ...
 * @purpose : this performs the read ,write from json file and update the json
 *          file. 
 */
public class FileConnection {
	...
	public HashMap<Appointment, Integer> readApp() throws IOException {
		HashMap<Appointment, Integer> Maplist = mapper.readValue(apfile,
				new TypeReference<HashMap<Appointment, Integer>>() {
				});
		return Maplist;
	}
