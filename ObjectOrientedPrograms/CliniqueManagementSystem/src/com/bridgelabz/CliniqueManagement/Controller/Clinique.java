 ...
 * @purpose : this perform the cliniqu management operations like add doctor, add
 *          patient , delet patient ,delete doctor, take an appointment,search
		...
		do {
			...
			case 6:
				...
				case 4:
					...
					System.out.println("id " + pi.getId() + "Age " + pi.getAge() + " Name " + pi.getName() + " mobile "
							+ pi.getPmbno());
					break;
				}
